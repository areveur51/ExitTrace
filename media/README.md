...
- Optional X-post screenshots live under `media/screenshots/{people|dog-comms|red-folder-comms|operations}/`. They are additive: a missing screenshot stays blank, and a stored portrait or still is never replaced. Corona comms use `people.screenshot`.
