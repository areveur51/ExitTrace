...
- Central-casting stills live under `media/central-casting-comms/`. Screenshots live under `media/screenshots/central-casting-comms/`. List thumbs are derived under `/media/thumbs/central-casting-comms/`. Detail keeps the gold still. Each row has a sense badge (`looks_the_part` or `replacement`).
