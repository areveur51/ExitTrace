...
- Central-casting evidence stills live under `media/central-casting-comms/`. Screenshots live under `media/screenshots/central-casting-comms/`. They render on the person detail, not as parent-list cards. Sense badges (`looks_the_part` or `replacement`) sit on the person card.
